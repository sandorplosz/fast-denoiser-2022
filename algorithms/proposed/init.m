...
load(strcat('/home/ps2014/Development/matlab/fast_denoiser_2022/data_generation/',irfs(selirf),'.mat'))
h=F(:,ceil(size(F,2)/2));
F_window=getIRFWindow(h,0.1);
%F = processF(F,K);

dataDir = strcat('/home/ps2014/Development/matlab/fast_denoiser_2022/data_generation/', irfs(selirf));
